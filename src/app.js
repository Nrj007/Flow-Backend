...
import giftVoucherRoutes from './modules/gift-vouchers/gift-voucher.routes.js';
...
app.use('/api/shops/:shopId/gift-vouchers', giftVoucherRoutes);
...
app.use('/api/shops/:shopId/departments', departmentRoutes);
